...
class ProductoController extends Controller
{
  ...
  public function update(UpdateProductoRequest $request, $id)
  {
    ...
    if ($request->hasFile('imagen')) {
      ...
      $imagenFilename = time() . '.' . $imagen->getClientOriginalExtension();
      $imagen->storeAs('public/img', $imagenFilename);
      $producto->imagen = $imagenFilename;
    }
    ...
    // Asignación de la promoción si existe
    if ($request->filled('idpromocion')) {
      $producto->idpromocion = $request->idpromocion;
    }
    $producto->save();
    //Bitacora
