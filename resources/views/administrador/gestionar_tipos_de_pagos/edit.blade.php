                    ...
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <!--route de form -->
                                    <form action="{{ route('tiposPagos.update', $tipoPago->id) }}" method="POST"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="text" name="nombre"
                                                value="{{ $tipoPago->nombre }}" placeholder="Ingrese el nombre del tipo de pago"/>
                                            @error('nombre')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="integer" name="nroCta"
                                                value="{{ $tipoPago->nroCta }}" placeholder="Ingrese el número de cuenta o número de telefono" />
                                            @error('nroCta')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
