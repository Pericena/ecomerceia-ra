  ...
  <div class="col-md-12">
    ...
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('reportes.proveedor', 'pdf') }}" class="btn btn-info" target="_blank">
          Reporte PDF <i class="fa fa-file"></i>
        </a>
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="btn-group">
                  <a href="{{ route('proveedor.edit', $proveedor->id) }}" class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
