      ...
      <div class="category-item-container has-scrollbar">
        <div class="category-item">
          <div class="category-img-box">
            <img src="./assets/images/icons/dress.svg" alt="Blusas" width="30">
          </div>
          <div class="category-content-box">
            <div class="category-content-flex">
              <h3 class="category-item-title">Blusas</h3>
              <p class="category-item-amount">(53)</p>
            </div>
            <a href="#" class="category-btn">Mostrar mas</a>
          </div>
        </div>
        <div class="category-item">
          <div class="category-img-box">
        ...
        <div class="category-item">
          <div class="category-img-box">
            <img src="./assets/images/icons/tee.svg" alt="Poleras" width="30">
          </div>
          <div class="category-content-box">
            <div class="category-content-flex">
              <h3 class="category-item-title">Poleras</h3>
