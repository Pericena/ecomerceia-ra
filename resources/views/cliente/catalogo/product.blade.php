        ...
        <!-- Ventana emergente para usar gafas VR -->
          <div class="popup" id="vrPopup">
            <div class="popup-message">
              <h2>Scan the QR code with your camera</h2>
              <p>To start the augmented reality adventure, download the QR code and
                </p>
                <p>
                  Scan it with your device's camera...</p>
              <center>
                <a href="rv-img/hiro.png" download="hiro.png" id="downloadLink">
                  <img src="rv-img/hiro.png" alt="Código QR" id="qrCode" width="150" height="150">
                  download
              </a>
              </center>
              <button class="btbaok" onclick="closePopup()">Start</button>
