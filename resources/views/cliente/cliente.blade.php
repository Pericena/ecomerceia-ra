                                ...
                                @else
                                    <div class="cart-dropdown">
                                        ...
                                        <div class="cart-btns">
                                            ...
                                            @else
                                                <a href="{{ route('pagos.index') }}">Verificar <i
                                                        class="fa fa-arrow-circle-right"></i></a>
                                            @endif
                                        </div>
                                    </div>
        ...
        <nav id="navigation" class="desktop-navigation-menu">
            <div class="container">
                <ul class="desktop-menu-category-list">
                    ...
                    <li
                        class="menu-category {{ 'cliente/catalogo' == Request::is('cliente/catalogo*') ? 'active' : '' }}">
                        <a href="{{ route('catalogo.index') }}">Catálogo</a>
                    </li>
                    <li
                        class="menu-category {{ 'cliente/categoriaShow' == Request::is('cliente/categoriaShow*') ? 'active' : '' }}">
                        <a href="{{ route('categoriaShow.index') }}">Categorías</a>
                    </li>
                    @auth
                        <li
                            class="menu-category {{ 'cliente/pedidosCliente' == Request::is('cliente/pedidosCliente*') ? 'active' : '' }}">
                            <a href="{{ route('pedidosCliente.index') }}">Pedidos</a>
                        </li>
                        <li
                            class="menu-category {{ 'cliente/AddressClient' == Request::is('cliente/AddressClient*') ? 'active' : '' }}">
...
<body>
  ...
  <!-- jQuery Plugins -->
>>>>>>> d69818a6be88e1aacce6658f48d9cd2ee45897d3
