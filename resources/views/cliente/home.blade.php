  ...
  <div class="row">
    <div class="col-md-12">
      <div class="section-title">
        ...
        <div class="section-nav">
          <ul class="section-tab-nav tab-nav">
            <li class=""><a data-toggle="tab" href="#tab2">Polos</a></li>
            <li><a data-toggle="tab" href="#tab2">Clásico</a></li>
            <li><a data-toggle="tab" href="#tab2">Spandex</a></li>
          ...
          <div id="tab2" class="tab-pane fade in active">
            <div class="products-slick" data-nav="#slick-nav-2">
              ...
              <div class="product">
                ...
                <div class="add-to-cart">
                  <button class="add-to-cart-btn" form="create{{ $a }}"><i class="fa fa-shopping-cart"></i>añadir</button>
                </div>
              </div>
              @endforeach
            </div>
